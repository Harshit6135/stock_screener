from config import ImpactCostConfig, TransactionCostConfig


def calculate_transaction_costs(
    trade_value: float, side: str, config: TransactionCostConfig = None
) -> dict:
    """
...
def calculate_buy_costs(trade_value: float, config: TransactionCostConfig = None) -> dict:
    """
...
def calculate_sell_costs(trade_value: float, config: TransactionCostConfig = None) -> dict:
    """
...
def calculate_impact_cost(order_pct_adv: float, config: ImpactCostConfig = None) -> float:
    """
...
def calculate_round_trip_cost(
    trade_value: float,
    order_pct_adv: float = 0.05,
    tx_config: TransactionCostConfig = None,
    impact_config: ImpactCostConfig = None,
) -> dict:
    """
